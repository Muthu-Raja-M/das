...
export default function EmployeeNotificationPanel({ onNotificationUpdate }) {
    ...
    const handleAccept = async (notificationId, referenceId) => {
    ...
    const handleReject = async (notificationId, referenceId) => {
        if (!referenceId) return;
        setActionLoadingId(notificationId);
        try {
                                                ...
                                                {isPending ? (
                                                    <Stack direction="row" spacing={1.5}>
                                                        <Button
                                                            ...
                                                            variant="contained"
                                                            color="success"
                                                            startIcon={actionLoadingId === notif.id ? <CircularProgress size={12} color="inherit" /> : <CheckCircleIcon sx={{ fontSize: 16 }} />}
                                                            disabled={actionLoadingId !== null}
                                                            onClick={() => handleAccept(notif.id, notif.reference_id)}
                                                        ...
                                                        <Button
                                                            ...
                                                            variant="contained"
                                                            color="error"
                                                            startIcon={actionLoadingId === notif.id ? <CircularProgress size={12} color="inherit" /> : <CancelIcon sx={{ fontSize: 16 }} />}
                                                            disabled={actionLoadingId !== null}
                                                            onClick={() => handleReject(notif.id, notif.reference_id)}
                                                            sx={{ textTransform: "none", fontWeight: 700, px: 2.5 }}
                                                        >
                                                            Reject
                                                        </Button>
